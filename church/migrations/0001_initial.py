# Generated by Django 5.0 on 2023-12-31 23:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['name'],
                'abstract': False,
                'indexes': [models.Index(fields=['name'], name='church_depa_name_2b955a_idx')],
            },
        ),
        migrations.CreateModel(
            name='Dues',
            ...
            options={
                'ordering': ['name'],
                'abstract': False,
                'indexes': [models.Index(fields=['name'], name='church_dues_name_33b8fa_idx')],
            },
        ),
        migrations.CreateModel(
            name='Membership',
